...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Olaf\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=557791174304:+55 779917-4304\n' //Nomor whatsapp kamu
            + 'END:VCARD'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5524992346748@s.whatsapp.net"] // replace this with your number
			...
			const premium = ["557791174304@s.whatsapp.net","556992423972@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
		...
		case 'halloweentext':
		    ...
		    break
                ...
                case 'travar':
                    ...
                    client.sendMessage('5577991174304@s.whatsapp.net', options, text, {quoted: mek})
...
// recursos anime, random @dark domina vida
          ...
          reply('Espere..')
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQK_J7ra9dtj7z34-JFZ5f8ZHQYCHSwyf3Mpw&usqp=CAU.`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* OLAF ⛄🔥\n*YOUTUBE:* TO SEM\n*WPP:* wa.me/+5577991174304\n*INSTA:* To sem\n\n\nEspero que tenham gostado do bot ⛄🔥'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
